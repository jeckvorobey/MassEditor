...
Для характеристик в версии 1.1.0 доступны только базовые общие характеристики товара: строка, текст, число и одиночное существующее значение из списка. SKU-характеристики, множественные значения, цвета, диапазоны, размерности и создание новых значений не входят в этот релиз.
