...
class shopMasseditorPluginI18nService
{
    ...
    private static $messages = array(
        ...
        'operation' => 'Operation',
        'confirm_warning_title' => 'Undo is available for the last operation.',
        'confirm_warning_text' => 'You can restore old values within 3 hours or until the next bulk operation.',
        'cancel' => 'Cancel',
        ...
        'rollback_busy' => 'Another Mass Editor operation is already running. Try again.',
        'rollback_invalid_snapshot' => 'The rollback snapshot is invalid.',
        'rollback_snapshot_save_failed' => 'The rollback snapshot could not be saved.',
        'rollback_invalid_request' => 'Invalid rollback request.',
        'rollback_confirm_required' => 'Confirm restoring the old values.',
        'rollback_unavailable' => 'This operation is no longer available for rollback.',
        'rollback_conflict' => 'The affected product values were changed after the bulk operation. Rollback was cancelled.',
        'rollback_restore_failed' => 'The old values could not be restored.',
        'rollback_log_description' => 'Rollback of operation #%d',
        'rollback_success' => 'The old values were restored.',
        'action_rollback' => 'Rollback',
        'rollback_button' => 'Undo',
        'rollback_modal_title' => 'Undo last operation',
        'rollback_confirm_question' => 'Are you sure you want to restore the old values?',
        'rollback_confirm_hint' => 'Only the products and values changed by this operation will be restored.',
        'rollback_submit' => 'Restore old values',
        'rollback_progress_title' => 'Restoring old values',
        'rollback_progress_message' => 'Products are being restored. Keep this window open.',
        'rollback_progress_label' => 'Rollback progress',
        'rollback_result_success' => 'Old values restored',
        'rollback_result_error' => 'Could not restore old values',
        ...
        'operation_progress_label' => 'Bulk operation progress',
        ...
        'video_url' => 'Video URL',
        'video_url_placeholder' => 'Rutube, VK, YouTube, or Vimeo video URL',
        ...
        'stock_type_filter' => 'Stock accounting type',
        'stock_type_all' => 'All products',
        'stock_type_without_warehouse' => 'Without warehouse accounting',
        'stock_type_with_warehouse' => 'With warehouse accounting',
        'stock_skipped_by_filter' => '%d products skipped by stock type filter',
        'feature' => 'Feature',
        'select_feature' => 'Select feature',
        'select_value' => 'Select value',
        'feature_mode' => 'Feature mode',
        'feature_value' => 'Feature value',
        'feature_type_boolean_yes' => 'Yes',
        'feature_type_boolean_no' => 'No',
        'feature_type_color_hint' => 'Enter a hex color value (e.g. #ff0000)',
        'feature_type_dimension_hint' => 'Enter a numeric value',
        'feature_type_range_hint' => 'Enter a numeric value',
        ...
        'validation_feature_boolean_value' => 'Enter 1 for yes or 0 for no.',
        ...
        'feature_values_limit' => 'Too many feature values selected.',
        'invalid_video_mode' => 'Invalid video mode.',
        'validation_video_url' => 'Enter a valid HTTP(S) video URL.',
        'validation_video_supported_url' => 'Copy and paste a video URL from Rutube, VK, YouTube, or Vimeo.',
        'video_save_failed' => 'The video URL could not be saved.',
        'product_edit_denied' => 'Not enough rights to edit the selected product.',
        ...
        'description_video' => 'Video: mode %s for %d products',
    ...
    private static $jsKeys = array(
        ...
        'operation_progress_title',
        'operation_progress_message',
        'operation_progress_label',
        'operation_result_success',
        'operation_result_error',
        'operation_result_close',
        'rollback_modal_title',
        'rollback_progress_title',
        'rollback_progress_message',
        'rollback_result_success',
        'rollback_result_error',
        ...
        'validation_stock',
        'validation_stock_required_for_accounted_products',
        'invalid_stock_value',
        'validation_feature',
        'validation_feature_value',
        'validation_video_url',
        'validation_video_supported_url',
        'video_save_failed',
        'validation_category',
        'feature_type_boolean_yes',
        'feature_type_boolean_no',
